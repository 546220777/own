...
[task_local]
#注销京东会员卡
55 23 * * 6 https://raw.githubusercontent.com/546220777/own/main/jdvip.js, tag=注销京东会员卡, img-url= https://raw.githubusercontent.com/58xinian/icon/master/jd_unbind.png, enabled=true
=======Loon========
[Script]
cron "55 23 * * 6" script-path=https://raw.githubusercontent.com/546220777/own/main/jdvip.js,tag=注销京东会员卡
========Surge==========
注销京东会员卡 = type=cron,cronexp="55 23 * * 6",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/546220777/own/main/jdvip.js
=======小火箭=====
注销京东会员卡 = type=cron,script-path=https://raw.githubusercontent.com/546220777/own/main/jdvip.js, cronexpr="10 23 * * 6", timeout=3600, enable=true
 */
...
async function unsubscribeCards() {
  ...
  for (let item of $.cardList) {
    ...
    console.log(`会员卡【${item.brandName}】`)
    console.log(`https://shopmember.m.jd.com/member/memberCloseAccount?venderId=${item.brandId}`)
  }
}
function showMsg() {
